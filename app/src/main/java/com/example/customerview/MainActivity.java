...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] foods = {"Chicken nuggets", "Fuchka", "Chips", "Biriyani", "Fried Rice", "Thai Soup"};
        ...
        ListAdapter customListAdapter = new com.example.customerview.CustomAdapter(this, foods);// Pass the food arrary to the constructor.
